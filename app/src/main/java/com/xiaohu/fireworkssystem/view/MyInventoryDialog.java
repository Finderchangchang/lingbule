...
public class MyInventoryDialog extends Dialog {
    private Button btnDelete, btnSave;
    private EditText etNum, txPrice;
    private TextView txName, txTotalNum, tvNumName;
    private Context myContext;
    private LinearLayout ll_productprice;

    public MyInventoryDialog(Context context, String name, String p, String num, String total, String numNAME) {
    ...
    private void setMyDialog() {
        View v = LayoutInflater.from(getContext()).inflate(R.layout.my_inventoryalertdialog, null);
        ...
        ll_productprice = (LinearLayout) v.findViewById(R.id.ll_productprice);
        ll_productprice.setVisibility(View.GONE);
