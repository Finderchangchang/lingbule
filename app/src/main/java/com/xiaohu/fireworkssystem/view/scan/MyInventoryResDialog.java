...
public class MyInventoryResDialog extends Dialog {
    private Button btnexit, btnSave;
    private EditText etNum;
    private Context myContext;
    public MyInventoryResDialog(Context context) {
    ...
    private void initView(){
        View v = LayoutInflater.from(getContext()).inflate(R.layout.my_inventory_dialog, null);
