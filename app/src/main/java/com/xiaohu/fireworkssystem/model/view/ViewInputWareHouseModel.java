...
public class ViewInputWareHouseModel implements Serializable {
    //入库单号
    ...
    //入库产口信息
   private ViewInputWareHouseRecordModel[] InputWareHouseRecord;
    ...
    public ViewInputWareHouseRecordModel[] getInputWareHouseRecord() {
        return InputWareHouseRecord;
    }

    public void setInputWareHouseRecord(ViewInputWareHouseRecordModel[] inputWareHouseRecord) {
